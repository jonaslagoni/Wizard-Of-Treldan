 ...
 * @author Mads
 */
public class Stairs_stone extends Abstract_sprite{
    /**
    ...
    public void setSprite(){
        ...
        super.getSprite().setSpritePosX(122);
        super.getSprite().setSpritePosY(658);
        super.getSprite().setSprite_width(91);
        super.getSprite().setSprite_height(32);
        super.getSprite().setWidth(91);
