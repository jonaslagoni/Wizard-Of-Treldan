 ...
 * @author jonas
 */
public class Interior_singlebed  extends Abstract_sprite{
    /**
     * Sets the Candle sprite
     */
    @Override
    public void setSprite(){
        super.getSprite().setSpritePosX(788);
        super.getSprite().setSpritePosY(498);
        super.getSprite().setSprite_width(32);
        super.getSprite().setSprite_height(90);
        super.getSprite().setWidth(32);
        super.getSprite().setHeight(90);
    }
}
